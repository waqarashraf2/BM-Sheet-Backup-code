...
class Order extends Model
{
    ...
    protected $fillable = [
        ...
        'address', 'client_name', 'company', 'branch', 'photographer', 'parent_company', 'CustomerParentCompany', 'client_portal_id', 'orignal_image_id',
    ...
    protected $casts = [
        ...
        'vf_count' => 'string',
        'flambient_order_count' => 'integer',
        'day_to_dusk_count' => 'integer',
        'object_removal_count' => 'integer',
        'it_datetime' => 'datetime',
        'editor_portal_account_id' => 'integer',
        'qc_portal_account_id' => 'integer',
        'fixing_started_at' => 'datetime',
        'fixing_completed_at' => 'datetime',
        'fixing_time_seconds' => 'integer',
