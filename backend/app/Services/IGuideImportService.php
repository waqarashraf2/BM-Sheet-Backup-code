...
class IGuideImportService
{
    protected int $projectId = 55;
    protected string $tableName = 'project_55_orders';
    protected string $serviceName = 'iGUIDE';
    protected string $defaultProjectType = 'iGuide';
    protected int $maxPages = 200;
    protected int $timeout = 60;
    protected string $ordersUrl = 'https://es-portal.captur3d.io/external_supplier/iguide_floorplan_orders';
