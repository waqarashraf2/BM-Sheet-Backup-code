...
{
    protected int $projectId = 27;
    protected string $tableName = 'project_27_orders';
    protected string $serviceName = 'Faro';
    protected string $defaultProjectType = 'faro';
    protected int $maxPages = 5;
    protected int $timeout = 45;
    protected int $pageDelayMicroseconds = 500000;
    protected string $ordersUrl = 'https://es-portal.captur3d.io/external_supplier/universal_floorplan_orders';
    ...
    public function import(): array
    {
        ...
        if ($this->portalUsername === '' || $this->portalPassword === '') {
        ...
        try {
            ...
            $auth = [$this->portalUsername, $this->portalPassword];
            $pendingRecords = $this->fetchStatus('pending', $auth, null);
            $processingRecords = $this->fetchStatus('processing', $auth, 'yes');
        ...
        foreach ($orders as $order) {
            ...
            $record = [
                ...
                'metadata' => $this->safeJsonEncode([
                    ...
                    'sla_status' => $order['slaStatus'] ?? null,
    ...
    protected function buildDateWindow(): array
    {
        ...
        $start->modify('-14 days')->setTime(0, 0, 0, 0)->setTimezone(new DateTimeZone('UTC'));
