...
class DashboardController extends Controller
{
    private const ASSIGNMENT_DASHBOARD_DUE_IN_OFFSETS = [
        16 => 2,
        2  => 0,  // Project 2 (Focal PB): keep due_in as stored, no extra hour conversion
    ];
    private const ASSIGNMENT_DASHBOARD_DUE_IN_RESPONSE_OFFSETS = [
        2 => -4, // Project 2 stores SLA deadline; assignment UI should show original portal-style due time
        16 => 2,
    ];
 ...
 public function dailyOperations(Request $request)
{
    ...
    $reportConfigHash = md5(json_encode([
        ...
        'strict_delivered_at_projects' => [3],
    ...
    private function generateDailyOperationsData(\Carbon\Carbon $dateObj, ?array $scopedProjectIds = null, string $viewMode = 'stage')
    {
        ...
        // Projects that must be counted strictly by delivered_at date for done metrics.
        $strictDeliveredAtProjects = [3];
        ...
        foreach ($projects as $project) {
            ...
            $workflowType = $project->workflow_type ?? 'FP_3_LAYER';
            $isFloorPlan  = $workflowType === 'FP_3_LAYER';
            $strictDeliveredAt = in_array((int) $project->id, $strictDeliveredAtProjects, true);
            ...
            if ($useReceivedAtOrderCounts) {
                ...
                if ($strictDeliveredAt) {
                    // Project-specific override: use delivered_at day only, independent of received_at.
        ...
        return [
            ...
            'report_config' => [
                ...
                'strict_delivered_at_projects' => $strictDeliveredAtProjects,
