import{j as a}from"./vendor-motion-mb8w6MQI.js";import{a as s}from"./vendor-redux-DvxbXa60.js";import{e as C}from"./index-CqPlIRcb.js";import"./vendor-react-Bp4g4aIW.js";import"./vendor-axios-C0Zqfgkc.js";function O(){const[m,_]=s.useState([]),[l,$]=s.useState(null),[g,S]=s.useState([]),[u,y]=s.useState([]),[D,p]=s.useState(!0),w=()=>{const t=new Date;return`${t.getFullYear()}-${(t.getMonth()+1).toString().padStart(2,"0")}-${t.getDate().toString().padStart(2,"0")}`},[d,b]=s.useState(w()),[r,j]=s.useState(null),x=async t=>{try{p(!0);const n=(await C.batchStatus({project_id:16,date:t})).data;j(n);const o=n.total_orders?.plans||0,i=n.total_orders?.done||0,c=n.total_orders?.pending||0,v=n.total_orders?.sent_to_fixing||0;_(n.batches||[]),$({total_batches:n.batches?.length||0,total_plans:o,total_done:i,total_pending:c,total_fixing:v}),S(n.plans_remaining||[]),y(n.hourly_counts||[])}catch(e){console.error("Batch Status Error:",e)}finally{p(!1)}};s.useEffect(()=>{x(d)},[]);const f=t=>{if(t){const[n,o,i]=t.split("-");if(n&&o&&i)return`${i}-${o}-${n}`}const e=new Date;return`${e.getDate().toString().padStart(2,"0")}-${(e.getMonth()+1).toString().padStart(2,"0")}-${e.getFullYear()}`},h=()=>{if(!m.length)return"";let t="";return t+=`Cubi 2D
`,t+=`${f(d)}
