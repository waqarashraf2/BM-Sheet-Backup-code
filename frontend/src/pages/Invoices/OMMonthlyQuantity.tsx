...
import { Lock, RefreshCw, Calendar, BarChart3, CheckCircle2, FileText, Search, ChevronDown, CheckCircle } from 'lucide-react';
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            >
                                <span className="truncate">
                                    {qtyProjectId
                                        ? projects.find(p => String(p.id) === qtyProjectId)?.name || 'Select project...'
                                        : 'Select project...'}
                                </span>
