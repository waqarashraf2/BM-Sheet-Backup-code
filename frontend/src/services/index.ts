...
export const projectService = {
  ...
  getClientIssuesDashboard: (params?: { project_id?: number; search?: string; status?: string; month?: string; page?: number }) => api.get<{ data: any[]; current_page: number; last_page: number; total: number; stats?: { total: number; waiting: number; in_progress: number; finished: number } }>('/client-issues/dashboard', { params }),
...
export const hrService = {
  ...
  emailDocuments: (userId: number, data: { email: string; subject: string; message: string; document_ids: number[] }) =>
